...
function useLogoColor(explicit?: string) {
  const [color, setColor] = useState(explicit ?? "#003334");
  ...
  useEffect(() => {
    ...
    const sync = () => {
      ...
      // Light = #003334
      // Dark = Tailwind orange-500
      setColor(isDark ? "#f97316" : "#003334");
    };
  ...
  return (
    ...
    >
      <style>{`
        ...
        .logo-aura {
          animation: automaticGlow ${durationMs}ms ease-in-out infinite;
        }
